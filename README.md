...
See [the reasoning prototype documentation](docs/STIMPY_REASONING_PROTOTYPE.md), [Pattern Learning documentation](docs/STIMPY_PATTERN_LEARNING.md), [Hypothesis Lab documentation](docs/STIMPY_HYPOTHESIS_LAB.md) and [Hypothesis Analysis documentation](docs/STIMPY_HYPOTHESIS_ANALYSIS.md) for models, rules, persistence and limits.
