...
See [the reasoning prototype documentation](docs/STIMPY_REASONING_PROTOTYPE.md) and [Pattern Learning documentation](docs/STIMPY_PATTERN_LEARNING.md) for models, rules, persistence and limits.
