...
StimpyBrain is a standalone passive observation, memory and descriptive-learning system for PandorickKi. It never writes to Pandorick, sends Telegram messages, contacts a real broker or creates real orders. The disabled Shitzo S.3 laboratory includes a purely virtual PaperBroker plus deterministic Trend, Momentum and Contrarian research traders, but still has no live feed, worker or automatic activity.
