...
Stimpy includes disabled-by-default Social Memory Lite for public RSS feeds and Reddit's official read-only API. It records idempotent public observations and descriptive BTC/ETH/XRP reaction windows without creating trading signals. X/Twitter is not part of the active composition. See [Social Memory Lite](docs/SOCIAL_MEMORY_LITE.md).
