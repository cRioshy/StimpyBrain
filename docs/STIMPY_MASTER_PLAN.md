...
4. **Hypotheses — foundation completed:** local bounded research questions, append-only Observation-linked evidence, independent-case deduplication, conservative status evaluation and GET-only projections. Reasoning, Critic, incubation, Inspiration and graph integration remain separate reviewed phases.
